...
On upgrade, existing History and recoverable dictations are preserved. Old
completed job rows are removed without recreating missing History or usage:
the old format cannot distinguish deleted history from an interrupted save.
New deliveries retain crash recovery for unfinished history bookkeeping.
