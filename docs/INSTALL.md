...
The first upgrade preserves existing History and recoverable dictations, but
does not backfill old completed jobs whose History or usage is missing. The
old format cannot distinguish a deleted entry from an interrupted save.
Subsequent deliveries still complete unfinished bookkeeping after a crash.
